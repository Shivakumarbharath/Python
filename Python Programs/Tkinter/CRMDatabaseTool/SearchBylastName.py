...
def search_cust():
    search_box=Toplevel()
    search_box.title("Search By Name")
    ...
    def searchnow():
        ...
        sql="SELECT * FROM customers WHERE last_name = '{}'".format(searched)
        ...
        if len(result)==1:
            ...
            searched_result = Label(search_box, text="Record not found...")
            searched_result.place(relx=0.1, rely=0.5)
    ...
    search_button.place(relx=0.5,rely=0.35)
