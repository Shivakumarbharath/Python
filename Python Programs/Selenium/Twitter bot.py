...
pwe = driver.find_element_by_xpath(
...
for i in range(15):
    happening = driver.find_element_by_xpath(
    ...
    happening.send_keys(content)
    tweet = driver.find_element_by_class_name(
        '//*[@id="react-root"]/div/div/div[2]/main/div/div/div/div/div/div[2]/div/div[3]/div[1]/div/div/div/div[2]/div[2]/div/div/div[2]/div')
    tweet.click()
