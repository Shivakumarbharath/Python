...
air_Travel = ['aisle', 'arrival', 'baggage', 'board', 'bulkhead', 'carry-on', 'coach', 'cockpit', 'connection', 'crew',
              'customs', 'declare',
              'departure', 'duty-free',
              'gate', 'itinerary', 'jet engine', 'jet lag', 'jumbo jet', 'landing', 'lavatory', 'luggage', 'one-way',
...
law = ['arrest', 'accuse', 'acquit', 'adjourn', 'adoption', 'alibi', 'alimony', 'appeal', 'appeal', 'attorney',
       'bankrupt', 'bribe',
       'brief', 'case', 'common-law', 'contract', 'copyright' 'court', 'criminal (adjective)', 'custody', 'damages',
       'death sentence', 'defend']

emotions = ['acceptance', 'admiration', 'affection', 'aggravation', 'anger', 'anguish', 'anxiety', 'attraction',
            'boredom', 'caution',
            'certainty', 'compassion', 'confidence', 'confusion', 'contentment', 'courage', 'curiosity', 'defeat',
            'defiance', 'delight',
            'dependence', 'depression', 'desire', 'disappointment', 'dislike', 'dismay', 'distress', 'embarrassment',
            'enthusiasm', 'envy']

body_parts = ['ankle', 'arch', 'arm', 'armpit', 'beard', 'breast', 'calf', 'cheek', 'chest', 'chin', 'earlobe', 'elbow',
              'eyebrow',
              'eyelash', 'eyelid', 'face', 'finger', 'forearm', 'forehead', 'gum', 'heel', 'hip', 'index finger', 'jaw',
              'knee', 'knuckle',
              'leg', 'lip', 'mouth', 'mustache']

non_count_nouns = ['advice', 'agriculture', 'air', 'anger', 'attention', 'chaos', 'clothing', 'courage', 'dirt',
                   'equipment', 'fun', 'furniture',
                   'garbage', 'homework', 'housework', 'information', 'jewelry', 'luck', 'luggage', 'mail', 'news',
                   'patience', 'permission',
