...
def DrawGrid(width, rows, surface):
    ...
    for i in range(rows):
        ...
        pygame.draw.line(surface, (255, 255, 255), (x, 0),
                         (x, width))  # draw a line on the surface in white colour from position x,0 to x,width
        pygame.draw.line(surface, (255, 255, 255), (0, y),
                         (width, y))  # draw a line on the surface in white colour from position 0,y to width,y
